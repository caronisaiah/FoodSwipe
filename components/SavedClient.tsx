    ...
    <div className="no-scrollbar flex-1 overflow-y-auto px-4 pb-8 pt-6">
      ...
      {!isLoaded ? (
        ...
        <div className="mt-20 flex flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[14rem] text-haze">
          ...
          {saved.map((r) => (
            ...
            >
              <Link
                ...
                className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-ink-2 text-3xl ring-1 ring-inset ring-white/5"
                aria-label={`Open ${r.name}`}
              >
                {cuisineEmoji(r.cuisineTags)}
              </Link>
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-center">
                ...
                <p className="truncate text-xs text-haze">
                  📍 {r.neighborhood} · {priceLabel(r.priceLevel)}
                </p>
              ...
              <button
                ...
                className="shrink-0 self-start rounded-full p-2 text-haze transition hover:bg-white/10 hover:text-coral"
              >
                ✕
              </button>
            </li>
